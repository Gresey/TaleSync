...
export default function GradientCard({ imagesrc, title }) {
  return (
    <Card
      sx={{
        minHeight: '280px',
    ...
    >
      ...
      <CardContent sx={{ justifyContent: 'flex-end', paddingBottom: '20px' }}>
        <Typography level="title-lg" textColor="#fff" sx={{ fontWeight: 'bold', textAlign: 'center',fontFamily:'Kalam,cursive' }}>
          {title}
        </Typography>
      </CardContent>
    </Card>
